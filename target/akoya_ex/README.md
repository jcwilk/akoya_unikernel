...
| [`raw_inspection_logs/`](raw_inspection_logs/) (deployment unit direct observation batch) | 2026-06-29 | (deployment unit) | **CPU** (Pentium M 735, family 6 model 13, 1.7 GHz, SSE2); **chipset** (855GM/ICH4-M PCI map); **memory** (~2 GiB installed); **wired NIC** (RTL8139 rev 10 at 01:02.0, IRQ 11, I/O 0xc100); **wireless** (Intel 2200BG at 01:01.0); **BIOS** (Insyde M1.02); **display** (1280×768 i915 panel); **input** (PS/2 keyboard + Synaptics touchpad); **storage class** (ICH4-M PATA, USB boot media observed) |
